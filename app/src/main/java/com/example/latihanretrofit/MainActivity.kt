...
import com.example.latihanretrofit.adapter.MovieAdapter
import com.example.latihanretrofit.model.Movie
import com.example.latihanretrofit.model.MovieResponse
import com.example.latihanretrofit.service.ApiClient
import com.example.latihanretrofit.service.ApiInterface
        ...
        call.enqueue(object : Callback<Movie> {
            ...
            override fun onResponse(call: Call<Movie>?, response: Response<Movie>?) {
                if (response != null) {
                    ...
                    if (posterPath == null) {
                        collapseImage.setImageResource(R.mipmap.icon_no_image)
                    } else {
